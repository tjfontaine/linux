...
// patch series wraps this file into the kernel tree at
// linux-6.12.76/drivers/bifrost/wire.rs.  The SHA above is
// audited by scripts/check-proto-drift.sh — bumping it requires
...
// one capability either side can advertise.  When a phase lands a new
// optional record kind, allocate a new FEATURE_* and gate its
